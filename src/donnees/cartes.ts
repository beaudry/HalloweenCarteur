...
const cartes: Carte[] = [
    ...
    { categorie: Categorie.defi, cycle: "Loup-Garou", description: "Va faire la chaise pendant 20 secondes.", titre: "Bain de lune" }, // Peut-être retravailler?
    ...
    { categorie: Categorie.defi, cycle: "Loup-Garou", description: "Le chasseur est sorti. Va te cacher dans la grotte (sous la table) jusqu'à ton prochain tour.", },
    ...
    { categorie: Categorie.verite, cycle: "Halloween", description: "Quel est ton film d'Halloween préféré?", titre: "" },
    { categorie: Categorie.verite, cycle: "Halloween", description: "Quel genre de sac utilisais-tu quand tu passais l'Halloween?", titre: "" },
    { categorie: Categorie.verite, cycle: "Halloween", description: "Tu as passé l'Halloween jusqu'à quel âge?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Dans quel cercle de l'enfer es-tu le plus probable d'aller?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Pour quelle raison irais-tu en prison?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Quelle est ton incantation préférée?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Qui est ta sorcière préféréé?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Qui est ton tueur préféré?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Selon toi, quelle est la pire malédiction que quelqu'un pourrait recevoir?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Si on remplaçait tous les humains par des copies toi, qu'est-ce qui va causer le premier meurtre?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mal", description: "Si tu devais tuer quelqu'un, quelle arme utiliserais-tu?", titre: "" },
    ...
    { categorie: Categorie.verite, cycle: "Marie/tue/fourre", description: ["Un loup-garou", "Un vampire", "Un zombie"], titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Lors d'un rituel occulte, qui manifesterais-tu, et que lui demanderais-tu?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Qu'est-ce qu'un inconnu pourrait te dire pour que tu rentres dans sa van?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Si tu étais dans un film d'horreur, quel rôle aurais-tu?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Si tu étais un fantôme, qu'hanterais-tu?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Tu reçois un bébé zombie, que tu ne peux pas donner. Que fais-tu?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Un tueur en série est dans ta maison/appartement. Où vas-tu te réfugier?", titre: "" },
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Une succube apparaît devant toi et désire ton « « essence » ». Lui donnes-tu?", titre: "" },
    { categorie: Categorie.verite, cycle: "Peur", description: "Quel animal te fait le plus peur?", titre: "" },
    { categorie: Categorie.verite, cycle: "Peur", description: "Quel film t'a le plus traumatisé quand tu étais enfant?", titre: "" },
    { categorie: Categorie.verite, cycle: "Peur", description: "Quel monstre tes parents utilisaient-ils pour te faire peur?", titre: "" },
    { categorie: Categorie.verite, cycle: "Peur", description: "Quelle est une de tes phobies les plus irrationnelles?", titre: "" },
    { categorie: Categorie.verite, cycle: "Spiritualité", description: "Dans quel cercle de l'enfer catholique serais-tu assigné?", titre: "" },
    { categorie: Categorie.verite, cycle: "Spiritualité", description: "Selon ton karma, en quoi te réincarnerais-tu?", titre: "" },
];
