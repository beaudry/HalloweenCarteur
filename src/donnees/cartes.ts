...
const cartes: Carte[] = [
    ...
    { categorie: Categorie.defi, cycle: "Social", description: "Trouve un/une non-joueur/euse et viens nous le/la présenter en quelques phrases." },
    ...
    { categorie: Categorie.chaos, cycle: "Réorganisation", description: "Réorganisez les pions pour que les joueurs avec les récipients les plus pleins soient en avant.", titre: "Vous êtes optimistes" },
    { categorie: Categorie.chaos, cycle: "Réorganisation", description: "Réorganisez les pions pour que les joueurs avec les récipients les plus vides soient avant.", titre: "Vous êtes pessimistes" },
    ...
    { categorie: Categorie.chaos, cycle: "Solidarité", description: "Avance le dernier joueur de trois cases." },
    { categorie: Categorie.chaos, cycle: "Solidarité", description: "Avance tous les joueurs sauf le premier de deux cases." },
    { categorie: Categorie.chaos, cycle: "Solidarité", description: "Recule le premier joueur de deux cases." },
    { categorie: Categorie.chaos, cycle: "Solidarité", description: "Tous les joueurs reculent de deux cases." },
