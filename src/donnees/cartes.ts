...
const cartes: Carte[] = [
    ...
    { categorie: Categorie.qui, cycle: "Film d'horreur", description: "Qui crierait le plus durant un film d'horreur?", titre: "Moumoune" },
    ...
    { categorie: Categorie.defi, cycle: "Enquête", description: "Trouve le frère ou la sœur de quelqu'un au party.", titre: "Bruh" }, // Nouveau
    ...
    { categorie: Categorie.defi, cycle: "Improvisation", description: "Explique au joueur à ta droite les petits caractères dans le contrat pour son âme.", titre: "Mauvais signe" }, // Nouveau
    { categorie: Categorie.defi, cycle: "Improvisation", description: "Présente aux autres élèves de ta classe ton piranha qui parle.", titre: "Il ne mord pas" }, // Nouveau
    { categorie: Categorie.defi, cycle: "Improvisation", description: "Explique à tes assurances comment un piano est tombé sur ton ou ta partenaire « accidentellement ».", titre: "Faux accord" }, // Nouveau
    ...
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui donnerait son sac de bonbons d'Halloween?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui volerait des bonbons dans ton sac d'Halloween?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui cognerait deux fois à la même maison à l'Halloween?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui aurait le costume le plus ridicule à l'Halloween?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui décore en août / en premier?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui garde ses décorations le plus longtemps?", },
    { categorie: Categorie.qui, cycle: "Célébration", description: "Qui célébrerait l'Halloween à l'année longue?", },
    { categorie: Categorie.qui, cycle: "Costume", description: "Qui aimerait être déguisé plus souvent?", },
    { categorie: Categorie.qui, cycle: "Costume", description: "Qui a décidé de son costume le plus à la dernière minute?", },
    { categorie: Categorie.qui, cycle: "Costume", description: "Qui a réutilisé son costume de l'année passée?", },
    { categorie: Categorie.qui, cycle: "Costume", description: "Qui a le plus beau costume?", },
    { categorie: Categorie.qui, cycle: "Costume", description: "Qui possède un maillot de bain orange?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui pourrait être un vampire?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui pourrait être un loup-garou?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui vendrait son âme au Diable?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui donnerait le plus d'informations aux aliens?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui mangerait de la chaire humaine?", },
    { categorie: Categorie.qui, cycle: "Traître", description: "Qui est un trafiquant d'organes?", },

    { categorie: Categorie.qui, description: "Qui serait pris dans Serpentard?", },
    { categorie: Categorie.qui, description: "Qui est le plus malchanceux?", },
    { categorie: Categorie.qui, description: "Qui a un téléphone avec moins de 5% de batterie?", },
    { categorie: Categorie.qui, description: "Qui aime le plus le chocolat?", },
    { categorie: Categorie.qui, description: "Qui était #TeamJacob en 2009?", },
    { categorie: Categorie.qui, description: "Qui frencherait un loup-garou?", },
    { categorie: Categorie.qui, description: "Qui tomberait en amour avec un fantôme?", },
    { categorie: Categorie.qui, description: "Envers qui un fantôme tomberait en amour?", },
    { categorie: Categorie.qui, description: "Qui te croirait si tu lui disais que tu pouvais prédire le futur?", },
    { categorie: Categorie.qui, description: "Qui t'aiderait à enterrer un cadavre?", },
    { categorie: Categorie.qui, description: "Qui ferait les meilleurs potions?", },
    { categorie: Categorie.qui, description: "Qui hurle le plus fort à la lune?", },
    { categorie: Categorie.qui, description: "Qui serait le meilleure chasseur de vampires?", },
    { categorie: Categorie.qui, description: "Qui sera le prochain à briser un miroir?", },
    { categorie: Categorie.qui, description: "Qui a l'aura la plus sensible?", },
    { categorie: Categorie.qui, description: "Qui peut parler aux morts?", },
    { categorie: Categorie.qui, description: "Qui jouerait à Ouija dans un cimetière?", },
    { categorie: Categorie.qui, description: "Qui garderait un zombie en cage pour l'étudier?", },
