...
const cartes: Carte[] = [
    ...
    { categorie: Categorie.defi, cycle: "Loup-Garou", description: "Montre ta supériorité et ton statut d'alpha en restant debout jusqu'à ton prochain tour.", titre: "Chef de la meute" },
    ...
    { categorie: Categorie.defi, cycle: "Social", description: "Va changer la chanson qui joue et mets celle de ton choix. Chante-la (et la table doit t'entendre)." },
    ...
    { categorie: Categorie.chaos, cycle: "Garde cette carte", description: "Utilise cette carte quand tu veux pour doubler la taille d'une conséquence de quelqu'un. La récompense est aussi doublée.", titre: "Portions doubles." },
    ...
    { categorie: Categorie.verite, cycle: "Mal", description: "Si on remplaçait tous les humains par des copies toi, quand se produira le premier meurtre\u202f?" },
    ...
    { categorie: Categorie.verite, cycle: "Mise en situation", description: "Si tu étais dans un film d'horreur, quel rôle occuperais-tu\u202f?" },
