...
const cartes: Carte[] = [
    ...
    { categorie: Categorie.chaos, cycle: "Garde cette carte", description: "Garde cette carte et utilise-la quand tu veux pour faire piger à n'importe qui une nouvelle conséquence.", titre: "Non merci!" },
    { categorie: Categorie.chaos, cycle: "Garde cette carte", description: "Garde cette carte et utilise-la quand tu veux pour réussir gratuitement une conséquence qui t'es assignée.", titre: "Oui merci!" },
    { categorie: Categorie.chaos, cycle: "Garde cette carte", description: "Garde cette carte et utilise-la pour doubler la taille d'une conséquence de n'importe qui. La récompense est aussi doublée.", titre: "Portions doubles." },
    ...
    { categorie: Categorie.verite, cycle: "Mal", description: "Si on remplaçait tous les humains par des copies toi, quand se produira le premier meurtre\u202f? (La réponse ne peut pas être jamais)." },
    ...
    { categorie: Categorie.verite, cycle: "Mal", description: "Dans quel cercle de l'enfer es-tu le plus probable d'aller\u202f? (limbes, luxure, gourmandise, avarice, colère, hérésie, fraude, trahison)." },
    ...
    { categorie: Categorie.verite, cycle: "Marie/tue/fourre", description: ["Leatherface (Massacre à la tronçonneuse)", "Jason Voorhees (Friday the 13th)", "Michael Myer (Halloween)"], titre: "Masques" },
    { categorie: Categorie.verite, cycle: "Marie/tue/fourre", description: ["Godzilla", "Mothra", "King Kong"], titre: "Animaux" },
    { categorie: Categorie.verite, cycle: "Marie/tue/fourre", description: ["Patrick Bateman (American Psycho)", "Sweeney Todd", "Hannibal Lecter"], titre: "Sigmas" },
